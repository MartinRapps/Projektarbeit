...
echo "=== Running SAM 3.1 Video Pre-processing ==="
...
read -p "Geben Sie den Begriff ein, der im Video maskiert werden soll (z.B. 'cable', 'pipe'): " TEXT_PROMPT
...
# Run with --input-mode video to enforce video segmentation and tracking
docker compose run --rm sam3-preprocess python3 /app/src/python/extract_masks_notebook_flow.py --prompt "$TEXT_PROMPT" --input-mode video
